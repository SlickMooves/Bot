...
module.exports = {
    ...
    async execute(interaction) {
        ...
        .then(json => {
		if(json.success) {
			interaction.editReply({ embeds: [new Discord.MessageEmbed().setTitle('License Successfully Activated!').addField('License Activated:', `${key}`).setColor("GREEN").setTimestamp()] })
        }
		else
        {
